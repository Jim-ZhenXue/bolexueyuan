<template>
    <div class="project-description">
      ...
      <div class="introduction">
        <p>
          本项目通过视觉化的方式帮助学习者理解乘法与面积之间的关系。
          该工具基于多元智能理论设计，通过直观的网格表示和交互式操作，
          使抽象的数学概念转化为可见可触的实体，促进深度学习。
        </p>
      </div>
      ...
      <div class="pedagogical-value">
        <h2>教学价值</h2>
        <p>
          通过将乘法运算转化为可视化的面积表示，本工具帮助学生建立数与空间的联系。
          学生可以直观地看到两个数相乘形成的矩形区域，加深对乘法本质的理解。
          这种表示法不仅适用于初学者，也为进一步学习代数和几何打下基础。
        </p>
      </div>
      ...
      <div class="usage-guide">
        <h2>使用指南</h2>
        <ol>
          <li>观察网格区域中的黄色高亮部分</li>
          <li>使用右侧控制面板的上下箭头调整因数大小</li>
          <li>拖动红色圆点可以直接改变黄色区域的大小</li>
          <li>注意查看右侧显示的乘积结果</li>
          <li>点击擦除工具可以重置为初始状态(1×1)</li>
          <li>使用网格切换按钮可以显示或隐藏网格线</li>
        </ol>
      </div>
    </div>
  </template>
